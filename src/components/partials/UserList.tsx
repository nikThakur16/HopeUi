...
// Your original data
const users = [
  { profile: '/assets/Gallery/CubeP.png', name: 'Anna Sthesia',  contact: '(760) 756 7568',   email: 'annasthesia@gmail.com', country: 'USA',      status: 'Active',   company: 'Acme Corporation',      joinDate: '2019/12/01' },
  { profile: '/assets/Gallery/CubeP.png', name: 'Brock Lee',    contact: '+62 5689 456 658',  email: 'brocklee@gmail.com',   country: 'Indonesia', status: 'Active',   company: 'Soylent Corp',         joinDate: '2019/12/01' },
  { profile: '/assets/Gallery/CubeP.png', name: 'Dan Druff',    contact: '+55 6523 456 856',  email: 'dandruff@gmail.com',   country: 'Brazil',    status: 'Pending',  company: 'Umbrella Corporation', joinDate: '2019/12/01' },
  { profile: '/assets/Gallery/CubeP.png', name: 'Hans Olo',     contact: '+91 2586 253 125',  email: 'hansolo@gmail.com',    country: 'India',     status: 'Inactive', company: 'Vehement Capital',     joinDate: '2019/12/01' },
  { profile: '/assets/Gallery/CubeP.png', name: 'Lynn Guini',   contact: '+27 2563 456 589',  email: 'lynnguini@gmail.com',  country: 'Africa',    status: 'Active',   company: 'Massive Dynamic',     joinDate: '2019/12/01' },
];
              ...
              {users.map((u, i) => (
                <tr key={i} className={i % 2 !== 0 ? 'bg-[#F2F2F2]' : 'bg-white'}>
                  <td className="px-4 py-2">
                    <img src={u.profile} alt="" className="w-8 h-8 rounded-full object-cover" />
                  </td>
                  ...
                  <td className="px-4 py-2">
                    <span className={`inline-block px-2 py-1 text-xs rounded-full font-semibold ${statusStyles[u.status]}`}>
                      {u.status}
                    </span>
                  </td>
                  ...
                  <td className="px-4 py-2 flex items-center space-x-2">
                    ...
                    <button className="p-2 bg-orange-500 rounded text-white hover:bg-orange-600 transition">
                      <FaEdit />
                    </button>
                    <button className="p-2 bg-red-500 rounded text-white hover:bg-red-600 transition">
                      <FaTrash />
                    </button>
                  </td>
                </tr>
